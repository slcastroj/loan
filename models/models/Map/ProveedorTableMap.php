...
class ProveedorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'models.models.Map.ProveedorTableMap';
     ...
     */
    const OM_CLASS = '\\models\\models\\Proveedor';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'models.models.Proveedor';
     ...
     */
    const COL_IDPROVEEDOR = 'proveedor.idProveedor';
     ...
     */
    const COL_ACTIVO = 'proveedor.activo';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idproveedor', 'Nombre', 'Activo', ),
        self::TYPE_CAMELNAME     => array('idproveedor', 'nombre', 'activo', ),
        self::TYPE_COLNAME       => array(ProveedorTableMap::COL_IDPROVEEDOR, ProveedorTableMap::COL_NOMBRE, ProveedorTableMap::COL_ACTIVO, ),
        self::TYPE_FIELDNAME     => array('idProveedor', 'nombre', 'activo', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idproveedor' => 0, 'Nombre' => 1, 'Activo' => 2, ),
        self::TYPE_CAMELNAME     => array('idproveedor' => 0, 'nombre' => 1, 'activo' => 2, ),
        self::TYPE_COLNAME       => array(ProveedorTableMap::COL_IDPROVEEDOR => 0, ProveedorTableMap::COL_NOMBRE => 1, ProveedorTableMap::COL_ACTIVO => 2, ),
        self::TYPE_FIELDNAME     => array('idProveedor' => 0, 'nombre' => 1, 'activo' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\models\\models\\Proveedor');
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idproveedor', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idproveedor', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idproveedor', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idproveedor', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idproveedor', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idproveedor', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Idproveedor', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ProveedorTableMap::COL_IDPROVEEDOR);
            $criteria->addSelectColumn(ProveedorTableMap::COL_NOMBRE);
            $criteria->addSelectColumn(ProveedorTableMap::COL_ACTIVO);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \models\models\Proveedor) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ProveedorTableMap::DATABASE_NAME);
            $criteria->add(ProveedorTableMap::COL_IDPROVEEDOR, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ProveedorTableMap::COL_IDPROVEEDOR) && $criteria->keyContainsValue(ProveedorTableMap::COL_IDPROVEEDOR) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.ProveedorTableMap::COL_IDPROVEEDOR.')');
        }
