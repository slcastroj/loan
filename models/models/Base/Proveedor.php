...
abstract class Proveedor implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\models\\models\\Map\\ProveedorTableMap';
    ...
    /**
     * Initializes internal state of models\models\Base\Proveedor object.
     */
     ...
     * @return $this|\models\models\Proveedor The current object (for fluent API support)
     */
    public function setIdproveedor($v)
    {
        ...
        if ($this->idproveedor !== $v) {
            $this->idproveedor = $v;
            $this->modifiedColumns[ProveedorTableMap::COL_IDPROVEEDOR] = true;
        }
    ...
    public function setActivo($v)
    {
        ...
        if ($this->activo !== $v) {
            $this->activo = $v;
            $this->modifiedColumns[ProveedorTableMap::COL_ACTIVO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProveedorTableMap::translateFieldName('Idproveedor', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idproveedor = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProveedorTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProveedorTableMap::translateFieldName('Activo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ProveedorTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\models\\models\\Proveedor'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProveedorTableMap::COL_IDPROVEEDOR)) {
            $modifiedColumns[':p' . $index++]  = 'idProveedor';
        }
        if ($this->isColumnModified(ProveedorTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(ProveedorTableMap::COL_ACTIVO)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\models\models\Proveedor
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdproveedor($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\models\models\Proveedor The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProveedorTableMap::COL_IDPROVEEDOR)) {
            $criteria->add(ProveedorTableMap::COL_IDPROVEEDOR, $this->idproveedor);
        }
        if ($this->isColumnModified(ProveedorTableMap::COL_NOMBRE)) {
            $criteria->add(ProveedorTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(ProveedorTableMap::COL_ACTIVO)) {
            $criteria->add(ProveedorTableMap::COL_ACTIVO, $this->activo);
        }
    ...
    {
        $validPk = null !== $this->getIdproveedor();
     ...
     * objects.
     *
     * @param      object $copyObj An object of \models\models\Proveedor (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \models\models\Proveedor Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildProveedor is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildProveedor The current object (for fluent API support)
     */
