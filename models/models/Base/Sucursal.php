 ...
 */
abstract class Sucursal implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\models\\models\\Map\\SucursalTableMap';
    ...
    /**
     * Initializes internal state of models\models\Base\Sucursal object.
     */
    ...
    /**
     * Compares this with another <code>Sucursal</code> instance.  If
     * <code>obj</code> is an instance of <code>Sucursal</code>, delegates to
     * <code>equals(Sucursal)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Sucursal The current object, for fluid interface
     */
     ...
     * @return $this|\models\models\Sucursal The current object (for fluent API support)
     */
    public function setIdsucursal($v)
    {
        ...
        if ($this->idsucursal !== $v) {
            $this->idsucursal = $v;
            $this->modifiedColumns[SucursalTableMap::COL_IDSUCURSAL] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[SucursalTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setActivo($v)
    {
        ...
        if ($this->activo !== $v) {
            $this->activo = $v;
            $this->modifiedColumns[SucursalTableMap::COL_ACTIVO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SucursalTableMap::translateFieldName('Idsucursal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idsucursal = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SucursalTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SucursalTableMap::translateFieldName('Activo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SucursalTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\models\\models\\Sucursal'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSucursalQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Sucursal::setDeleted()
     * @see Sucursal::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSucursalQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SucursalTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SucursalTableMap::COL_IDSUCURSAL)) {
            $modifiedColumns[':p' . $index++]  = 'idSucursal';
        }
        if ($this->isColumnModified(SucursalTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(SucursalTableMap::COL_ACTIVO)) {
    ...
    {
        $pos = SucursalTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Sucursal'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Sucursal'][$this->hashCode()] = true;
        $keys = SucursalTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\models\models\Sucursal
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\models\models\Sucursal The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SucursalTableMap::COL_IDSUCURSAL)) {
            $criteria->add(SucursalTableMap::COL_IDSUCURSAL, $this->idsucursal);
        }
        if ($this->isColumnModified(SucursalTableMap::COL_NOMBRE)) {
            $criteria->add(SucursalTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(SucursalTableMap::COL_ACTIVO)) {
            $criteria->add(SucursalTableMap::COL_ACTIVO, $this->activo);
        }
    ...
    {
        $criteria = ChildSucursalQuery::create();
        $criteria->add(SucursalTableMap::COL_IDSUCURSAL, $this->idsucursal);
    ...
    {
        $validPk = null !== $this->getIdsucursal();
     ...
     * objects.
     *
     * @param      object $copyObj An object of \models\models\Sucursal (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \models\models\Sucursal Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSucursal is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSucursal The current object (for fluent API support)
     */
    public function setBoletas(Collection $boletas, ConnectionInterface $con = null)
    {
        ...
        foreach ($boletasToDelete as $boletaRemoved) {
            $boletaRemoved->setSucursal(null);
        }
     ...
     * @return ObjectCollection|ChildBoleta[] List of ChildBoleta objects
     */
    public function getBoletasJoinUsuario(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBoletaQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(SucursalTableMap::DEFAULT_STRING_FORMAT);
    }
