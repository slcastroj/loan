...
use models\models\Map\ProveedorTableMap;
 ...
 *
 *
 * @method     ChildProveedorQuery orderByIdproveedor($order = Criteria::ASC) Order by the idProveedor column
 * @method     ChildProveedorQuery orderByNombre($order = Criteria::ASC) Order by the nombre column
 * @method     ChildProveedorQuery orderByActivo($order = Criteria::ASC) Order by the activo column
 *
 * @method     ChildProveedorQuery groupByIdproveedor() Group by the idProveedor column
 * @method     ChildProveedorQuery groupByNombre() Group by the nombre column
 * @method     ChildProveedorQuery groupByActivo() Group by the activo column
 *
 ...
 *
 * @method     ChildProveedorQuery leftJoinProducto($relationAlias = null) Adds a LEFT JOIN clause to the query using the Producto relation
 * @method     ChildProveedorQuery rightJoinProducto($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Producto relation
 * @method     ChildProveedorQuery innerJoinProducto($relationAlias = null) Adds a INNER JOIN clause to the query using the Producto relation
 *
 * @method     ChildProveedorQuery joinWithProducto($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Producto relation
 *
 * @method     ChildProveedorQuery leftJoinWithProducto() Adds a LEFT JOIN clause and with to the query using the Producto relation
 * @method     ChildProveedorQuery rightJoinWithProducto() Adds a RIGHT JOIN clause and with to the query using the Producto relation
 * @method     ChildProveedorQuery innerJoinWithProducto() Adds a INNER JOIN clause and with to the query using the Producto relation
 *
 ...
 *
 * @method     ChildProveedor findOneByIdproveedor(int $idProveedor) Return the first ChildProveedor filtered by the idProveedor column
 * @method     ChildProveedor findOneByNombre(string $nombre) Return the first ChildProveedor filtered by the nombre column
 * @method     ChildProveedor findOneByActivo(int $activo) Return the first ChildProveedor filtered by the activo column *
 ...
 *
 * @method     ChildProveedor requireOneByIdproveedor(int $idProveedor) Return the first ChildProveedor filtered by the idProveedor column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildProveedor requireOneByActivo(int $activo) Return the first ChildProveedor filtered by the activo column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildProveedor[]|ObjectCollection findByIdproveedor(int $idProveedor) Return ChildProveedor objects filtered by the idProveedor column
 ...
 * @method     ChildProveedor[]|ObjectCollection findByActivo(int $activo) Return ChildProveedor objects filtered by the activo column
...
abstract class ProveedorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \models\models\Base\ProveedorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\models\\models\\Proveedor', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT idProveedor, nombre, activo FROM proveedor WHERE idProveedor = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ProveedorTableMap::COL_IDPROVEEDOR, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ProveedorTableMap::COL_IDPROVEEDOR, $keys, Criteria::IN);
    }
    ...
    public function filterByIdproveedor($idproveedor = null, $comparison = null)
    {
        if (is_array($idproveedor)) {
            ...
            if (isset($idproveedor['min'])) {
                $this->addUsingAlias(ProveedorTableMap::COL_IDPROVEEDOR, $idproveedor['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idproveedor['max'])) {
                $this->addUsingAlias(ProveedorTableMap::COL_IDPROVEEDOR, $idproveedor['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProveedorTableMap::COL_IDPROVEEDOR, $idproveedor, $comparison);
    }
    ...
    public function filterByActivo($activo = null, $comparison = null)
    {
        if (is_array($activo)) {
            $useMinMax = false;
            if (isset($activo['min'])) {
                $this->addUsingAlias(ProveedorTableMap::COL_ACTIVO, $activo['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($activo['max'])) {
                $this->addUsingAlias(ProveedorTableMap::COL_ACTIVO, $activo['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProveedorTableMap::COL_ACTIVO, $activo, $comparison);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildProveedorQuery The current query, for fluid interface
     */
    public function filterByProducto($producto, $comparison = null)
    {
        if ($producto instanceof \models\models\Producto) {
            return $this
                ->addUsingAlias(ProveedorTableMap::COL_IDPROVEEDOR, $producto->getIdproveedor(), $comparison);
    ...
    {
        if ($proveedor) {
            $this->addUsingAlias(ProveedorTableMap::COL_IDPROVEEDOR, $proveedor->getIdproveedor(), Criteria::NOT_EQUAL);
        }
