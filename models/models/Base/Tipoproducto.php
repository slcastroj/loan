...
/**
 * Base class that represents a row from the 'tipoproducto' table.
 *
 *
 *
 * @package    propel.generator.models.models.Base
 */
abstract class Tipoproducto implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\models\\models\\Map\\TipoproductoTableMap';
    ...
    /**
     * Initializes internal state of models\models\Base\Tipoproducto object.
     */
    ...
    /**
     * Compares this with another <code>Tipoproducto</code> instance.  If
     * <code>obj</code> is an instance of <code>Tipoproducto</code>, delegates to
     * <code>equals(Tipoproducto)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Tipoproducto The current object, for fluid interface
     */
     ...
     * @return $this|\models\models\Tipoproducto The current object (for fluent API support)
     */
    public function setIdtipoproducto($v)
    {
        ...
        if ($this->idtipoproducto !== $v) {
            ...
            $this->modifiedColumns[TipoproductoTableMap::COL_IDTIPOPRODUCTO] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[TipoproductoTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setActivo($v)
    {
        ...
        if ($this->activo !== $v) {
            $this->activo = $v;
            $this->modifiedColumns[TipoproductoTableMap::COL_ACTIVO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TipoproductoTableMap::translateFieldName('Idtipoproducto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idtipoproducto = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TipoproductoTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TipoproductoTableMap::translateFieldName('Activo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = TipoproductoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\models\\models\\Tipoproducto'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTipoproductoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Tipoproducto::setDeleted()
     * @see Tipoproducto::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTipoproductoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TipoproductoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TipoproductoTableMap::COL_IDTIPOPRODUCTO)) {
            $modifiedColumns[':p' . $index++]  = 'idTipoProducto';
        }
        if ($this->isColumnModified(TipoproductoTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(TipoproductoTableMap::COL_ACTIVO)) {
            $modifiedColumns[':p' . $index++]  = 'activo';
        }

        $sql = sprintf(
            'INSERT INTO tipoproducto (%s) VALUES (%s)',
    ...
    {
        $pos = TipoproductoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tipoproducto'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tipoproducto'][$this->hashCode()] = true;
        $keys = TipoproductoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdtipoproducto(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\models\models\Tipoproducto
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdtipoproducto($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\models\models\Tipoproducto The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TipoproductoTableMap::COL_IDTIPOPRODUCTO)) {
            $criteria->add(TipoproductoTableMap::COL_IDTIPOPRODUCTO, $this->idtipoproducto);
        }
        if ($this->isColumnModified(TipoproductoTableMap::COL_NOMBRE)) {
            $criteria->add(TipoproductoTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(TipoproductoTableMap::COL_ACTIVO)) {
            $criteria->add(TipoproductoTableMap::COL_ACTIVO, $this->activo);
        }
    ...
    {
        $criteria = ChildTipoproductoQuery::create();
        $criteria->add(TipoproductoTableMap::COL_IDTIPOPRODUCTO, $this->idtipoproducto);
    ...
    {
        $validPk = null !== $this->getIdtipoproducto();
    ...
    /**
     * Generic method to set the primary key (idtipoproducto column).
     *
    ...
    {
        return null === $this->getIdtipoproducto();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \models\models\Tipoproducto (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdtipoproducto(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \models\models\Tipoproducto Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTipoproducto is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTipoproducto The current object (for fluent API support)
     */
     ...
     * @return ObjectCollection|ChildProducto[] List of ChildProducto objects
     */
    public function getProductosJoinMarca(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TipoproductoTableMap::DEFAULT_STRING_FORMAT);
    }
